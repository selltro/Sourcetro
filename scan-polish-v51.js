(() => {
  ...
  function polishScanLens() {
    document.querySelectorAll(".st-lens").forEach((lens) => {
      lens.className = "tro-orb st-v51-lens";
      lens.dataset.mood = "ready";
      lens.innerHTML = "<i></i>";
    });
  }

  function showScanWithoutOpeningCamera() {
    closeMobileMenu();
    if (typeof state !== "undefined" && state.route !== "source-scan" && typeof setRoute === "function") {
  ...
  style.textContent = `
    .st-v51-lens{display:inline-flex!important;width:112px!important;height:112px!important;margin:0 auto 16px!important;transform:none!important;box-shadow:0 0 0 8px rgba(85,188,231,.12),0 0 26px rgba(85,188,231,.35)!important}
    @media(max-width:820px){.st-v51-lens{width:104px!important;height:104px!important}}
  `;
  ...
  window.addEventListener("pageshow", () => { closeMobileMenu(); setTimeout(polishScanLens, 60); });
