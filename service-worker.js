const CACHE = "sourcetro-v64-search-while-capturing";
const APP_START = "./?app=1&v=64";
const SHELL = [
  "./",
  "./index.html",
  APP_START,
  ...
  "./styles.css?v=64",
  "./mobile-navigation.css?v=64",
  "./assets/sourcetro-mark.svg",
  "./trusted-session.js?v=64",
  "./phone-stability-v52.js?v=64",
  "./mobile-image-pipeline-v52.js?v=64",
  "./app.js?v=64",
  "./tro-chat.js?v=64",
  "./memory-guard.js?v=64",
  "./ebay-oauth.js?v=64",
  "./ebay-import.js?v=64",
  "./ebay-edit-safety.js?v=64",
  "./seller-workflow.js?v=64",
  "./discovery-scan-v52.js?v=64",
  "./cloud-sync.js?v=64",
  "./sync-recovery.js?v=64",
  "./mobile-inventory-edit.js?v=64",
  "./ui-stability.js?v=64",
  "./secure-access-v56.js?v=64",
  "./install-app.js?v=64",
  "./pwa-update.js?v=64",
];
